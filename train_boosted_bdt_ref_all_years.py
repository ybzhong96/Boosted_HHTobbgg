...
from BDT_preprocess_ref import FEATURES as BDT_VARIABLES
...
XGB_PARAMS = {
    ...
    "max_depth": 3,
    "eta": 0.01,
    # Match boosted/config.py XGBHyperparameters.reg_lambda.
    "lambda": 10.0,
    "alpha": 1.0,
    "subsample": 0.6,
...
def save_outputs(
    ...
    models,
    output_dir,
    oof_name="trainning_ref_oof_scores.parquet",
    summary_name="trainning_ref_summary.csv",
    model_subdir="xgb_ref_models",
):
    ...
    for i, booster in enumerate(models):
        booster.save_model(model_dir / f"xgb_ref_fold{i}.json")
